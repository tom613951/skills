...
**浏览技能网站：** https://lively-pythagoras.vercel.app/
...
在运行 CLI 搜索之前，先检查 [技能排行榜](https://lively-pythagoras.vercel.app/)，看是否已有该领域知名度较高的技能。排行榜按总安装量对技能进行排序，能够直观地展示最受欢迎且经过实战检验的选项。
...
2. 安装量和来源
3. 他们可以运行的安装命令
4. 在 lively-pythagoras.vercel.app 上了解更多的链接
...
了解更多：https://lively-pythagoras.vercel.app/
```
